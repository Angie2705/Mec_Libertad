        ...
        <nav className={`bg-white shadow-md md:py-4 transition-transform duration-700 ${showNavBar ? 'translate-y-0' : '-translate-y-full'}`}>
            <div className="flex items-center">
              ...
              <div className="absolute end-5 top-5">
                <button data-collapse-toggle="navbar-sticky" type="button" class="inline-flex md:hidden p-2 w-10 h-10 rounded-lg hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-gray-200 
              ...
              <ul class="hidden md:flex w-full justify-center md:gap-x-8 bg-white text-gray-900 font-semibold ">
                <li className="hover:bg-gray-300 px-4 py-2 rounded-md"> <a className="text-sm " href="">Inicio</a> </li>
                <li className="hover:bg-gray-300 px-4 py-2 rounded-md"> <a className="text-sm" href="">Nosotros</a> </li>
                <li className="hover:bg-gray-300 px-4 py-2 rounded-md"> <a className="text-sm" href="">Servicios</a> </li>
                <li className="hover:bg-gray-300 px-4 py-2 rounded-md">
                  <NavLink to='/producto'>
                    <a className="text-sm font-semibold" href="">Productos</a>
                  </NavLink>
                </li>
              </ul> 
            </div>
            ...
            {isMenuOpen ? (
              <ul class="flex-col md:hidden pl-8 bg-white text-gray-900" >
                <li className="font-semibold py-3 px-6 hover:bg-gray-300 rounded-md"> <a className="text-sm" href="">Inicio</a> </li>
                <li className="font-semibold py-3 px-6 hover:bg-gray-300 rounded-md"> <a className="text-sm" href="">Nosotros</a> </li>
                <li className="font-semibold py-3 px-6 hover:bg-gray-300 rounded-md"> <a className="text-sm" href="">Servicios</a> </li>
                <li className="font-semibold py-3 px-6 hover:bg-gray-300 rounded-md">
                  <NavLink to='/producto'>
                    <a className="text-sm font-semibold" href="">Productos</a>
                  </NavLink>
                </li>
