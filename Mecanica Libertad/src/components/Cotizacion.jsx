                        ...
                        <div key={id} className='mt-4'>
                            <div className='flex items-center justify-between border rounded-lg bg-white shadow-md p-4'>
                                ...
                                <div className='flex items-center px-4'>
                                    ...
                                    <input className='w-16 p-2 border border-gray rounded-lg text-center focus:outline-none focus:ring-2 focus:ring-red-700' defaultValue={item.cantidad}
                                        type="number" min={1} max={200} name="" id="" onChange={e => handleQuantity(id, parseInt(e.target.value) || 1)} />
                                </div>

                                <button onClick={() => showModal(id)} className='no-print p-2 rounded-lg bg-red-200 hover:bg-red-400 hover:text-white '>
