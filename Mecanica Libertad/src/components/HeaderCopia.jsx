...
const HeaderCopia = () => {
    ...
    return(
        <nav className={`z-40 lg:fixed flex mx-auto items-center justify-between lg:px-10 px-8 lg:w-full bg-white transition-transform duration-700 ${showNavBar ? 'translate-y-0' : '-translate-y-full'}`}>
