    ...
    return (
        ...
        <form onSubmit={handleSubmit(functionAuth)} className=' mt-10 space-y-4 md:space-y-6' >
            ...
            <div className='flex justify-center items-center'>
                <button type="submit" className="px-4 py-2 text-base rounded-full bg-red-600 text-white hover:bg-red-700">{regis ? "Registrate" : "Iniciar sesión"}</button>
                <h4>{regis ? "Si ya tienes cuenta: " : "Si no tienes cuenta:"}
                    <button onClick={() => setRegister(!regis)} className='px-1 text-base rounded-full bg-gray-600 text-white hover:bg-red-700'>{regis ? "Inicia sesión" : "Registrate"}</button>
                </h4>
