...
function Nosotros() {
  return (
    ...
    <section id="nosotros" className=" mt-3 
   ...
   ">
      ...
      <div className="flex flex-col text-left items-center justify-center  rounded-lg md:py-5 bg-red-800 ml-16 col-span-2" >
        
        <p className="text-md text-white md:px-6 lg:px-12 lg:py-6 word-space rounded-lg text-justify" style={{wordSpacing:'8px'}}>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-1 md:grid-cols-1 gap-5 lg:gap-10 h-screen sm:h-auto p-2 md:p-6 lg:p-8 bg-gray-200 rounded-lg pb-5">
