  ...
  return (
    <>
      <figure className="relative transition-all duration-300 cursor-pointer filter grayscale hover:grayscale-0 hover:scale-105  hover:outline hover:outline-4 rounded-lg hover:outline-white hover:z-10 group">
        ...
        <figcaption className="absolute px-4 text-lg text-white bottom-4 mt-4 flex flex-col items-center left-1/2 transform -translate-x-1/2">
          <p>Trabajos en plásticos técnicos.</p>
          <button
            onClick={mostrarCard}
            className="mt-2 bg-slate-500 hover:bg-slate-700 text-white font-bold text-sm py-2 px-4 rounded-full opacity-0 transition-opacity duration-500 ease-in-out group-hover:opacity-100"
          >
            Ver más
          </button>
        </figcaption>
